...
module.exports = function(Veritrans) {
    ...
    const transactions = {
        ...
        deny(id, callback) {
            return makeApiCall('POST', `${Veritrans.baseUrl}/${id}/deny`, {}, callback);
        },
        ...
        refund(id, payload, callback) {
            return makeApiCall('POST', `${Veritrans.baseUrl}/${id}/refund`, payload, callback);
        },
